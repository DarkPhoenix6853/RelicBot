...
exports.run = async (client, message, args) => {
    ...
    currentPlayer.mute = false;
    client.playerDB.set(message.author.id, currentPlayer);

    message.reply(`I will ping you again`);
};
...
exports.help = (client, message) => {
    ...
    const helpMessage = `Reverses the Mute command so the bot will again ping you for subscribed relics. 

Usage: ${client.config.get('baseConfig').prefix}unmute`;
